...
| 平台 | 当前状态 | 入口 |
| --- | --- | --- |
| macOS App | 当前主力可用 | 打开 Click / Sentence Reader App |
...
| P2 | 可产品化 | 用 WebView2 或 Tauri 做 `Click.exe`，自动启动 Reader API 并打开 `/library` |
| P3 | 发行阶段 | 做安装包、开始菜单快捷方式、可选桌面快捷方式、启动诊断和卸载逻辑 |
