<p align="center">
  <img src="docs/images/click-icon.png" width="112" alt="Click icon">
</p>
...
<p align="center">
  <img alt="local first" src="https://img.shields.io/badge/local--first-yes-9bcf94">
  <img alt="platform" src="https://img.shields.io/badge/platform-macOS-111827">
  <img alt="format" src="https://img.shields.io/badge/format-EPUB-f0c75e">
  <img alt="reader api" src="https://img.shields.io/badge/API-FastAPI-2f855a">
  <img alt="database" src="https://img.shields.io/badge/database-PostgreSQL-336791">
</p>

<p align="center">
  <img src="docs/images/click-library-desktop.png" width="920" alt="Click library dashboard">
</p>
...
<p align="center">
  <img src="docs/images/click-library-mobile.png" width="260" alt="Click mobile library">
</p>
...
GitHub 只保存源码、文档、迁移脚本、小型测试样本和产品说明图。
