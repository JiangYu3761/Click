...
| 操作 | 结果 |
| --- | --- |
| 单击句子 | 聚焦当前句；如果这句话已有备注，会显示备注预览 |
| 单击英文单词 | 查词 |
| 快速双击句子 | 添加或编辑这句话的备注 |
| 慢慢点两次 | 会被当成两次单击，不等于双击，不会打开备注 |
| 右键句子 | 整句标红 / 取消标红 |
| 双指点按句子 | 整句标红 / 取消标红 |
| `Option` + 双击英文词 | 备用查词路径 |
| 选中文字后 `Command+C` | 复制选中的文字 |
| `Esc` | 关闭备注、查词、抽屉等临时浮层 |
| `Command+Q` | 退出 Sentence Reader |
...
| 点击英文单词 | 查词 |
| 快速双击句子 | 添加备注 |
| 慢慢点两次 | 会被当成两次点击，不等于双击 |
| 长按句子 | 整句标红 / 取消标红 |
| 左右滑动 | 翻页 |
| `Aa` | 调整字号、行高、左右边距 |
| `书库` | 回到主界面 |

原则：在正文句子上，Sentence Reader 的句子级操作优先。复制文字仍然用 `Command+C` 或避开句子区域的系统菜单。
