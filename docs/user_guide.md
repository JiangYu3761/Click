...
它的核心不是“打开一本书”，而是在读到一句有价值的话时，用最短动作完成备注、语音转文字备注和整句标红。
...
| 查英文词 | 点击英文单词 | 弹出词义 |
| 写备注 | 快速双击句子 | 打开备注 |
| 写语音备注 | 点击句子后点 `语音` | 录音或降级为手动备注 |
| 整句标红 | 点击句子后点 `红标` | 整句话变红 / 取消标红 |
| 翻页 | 左右滑动 | 上一页 / 下一页 |
...
- Mac 端可以在备注弹窗或运行环境页选择 `苹果` / `FunASR`。
- 默认使用苹果系统语音识别。
- FunASR 保留为本地可选识别。
...
```text
PostgreSQL database: sentence_reader
schema: reader
```
